// server.js
// SmartParking Backend mit Azure SQL Database
...
app.post("/api/register", async (req, res) => {
  try {
    ...
    const existsRes = await pool
      ...
      .query("SELECT 1 AS x FROM dbo.Users WHERE LOWER(Email) = LOWER(@Email);");
    ...
    await pool
      ...
      .input("Geburtsdatum", sql.Date, geburtsdatum || null)
